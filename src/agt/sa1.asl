...
// sa1: Fast delivery, mid-range pricing
can_supply(board, 150, 18, 0.95).      // $150, 18hr delivery, 95% reputation
can_supply(trunk, 55, 14, 0.93).       // $55, 14hr, 93% reputation
can_supply(wheels, 35, 12, 0.94).      // $35, 12hr, 94% reputation
